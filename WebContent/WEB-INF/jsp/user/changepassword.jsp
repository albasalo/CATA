...
<html>
	...
	<body>
		...
		<div id="page">
			<div id="content">
				<form id="changepassword_form" class="width510" action="<c:url value='/user/changepassword'/>" method="post">
				<fieldset>
					<legend>Alterar senha</legend>
						<div class="single_form_element">
							<label class="label" for="curpass">Atual senha</label>
							<br />
							<input id="current" class="input_border width285" type="password" maxlength=100 name="currentPassword" /><br />
						</div>
						<div class="single_form_element">
						...
						<div class="single_form_element">
							<label class="label" for="pass2">Redigite a nova senha</label>
							<br />
							<input id="pass2" class="input_border width285" type="password" maxlength=32 name="password2" /><br />
							<span id="pass2Info" class="description">Confirme a nova senha</span>
						</div>
